    ...
    .then(({ choice }) => {
      ...
      switch (choice) {
        ...
        case "ADD_DEPT":
          ...
          break;
        case "EXIT_CLI":
          console.log("exitingCLI and writing file");
          break;
        default:
          quitCli();
      }
        ...
        .then((response, error) => {
          ...
          inquirer
            ...
            .then((answer) => {
              ...
              let result = db.query(sqls, [newTitleId, employeeId]);
  ...
  try {
    ...
    const insert = await db
      ...
      .query(
        ...
        [response.roleName, response.roleSalary, response.roleDepartment]
      );
